"""LangGraph + EvoUndo Canonical Reliability Demo."""
import sqlite3
...
@harness.protect(
    ...
    capture_fn=lambda state: get_stock(),
...
langgraph_node.execute({"step": 1}, __logical_mutation_id="mut_lg_01")
print("Stock after LangGraph node:", get_stock())
langgraph_node.execute({"step": 1}, __logical_mutation_id="mut_lg_01")
print("Stock after retry:", get_stock(), "(Duplicate suppressed! ✅)")
harness.revert("mut_lg_01")
