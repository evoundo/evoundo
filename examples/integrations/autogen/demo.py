"""Microsoft AutoGen / AG2 + EvoUndo Canonical Reliability Demo."""
import sqlite3
...
autogen_tool.execute(__logical_mutation_id="mut_ag_01")
print("Stock after AutoGen tool:", get_stock())
autogen_tool.execute(__logical_mutation_id="mut_ag_01")
print("Stock after retry:", get_stock(), "(Duplicate suppressed! ✅)")
harness.revert("mut_ag_01")
